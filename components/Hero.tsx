    ...
    <section className="relative h-screen w-full overflow-hidden bg-black">
      ...
      >
        ...
        <video 
          ...
          poster="https://images.unsplash.com/photo-1544367563-12123d8965cd?q=80&w=2070&auto=format&fit=crop"
        >
          {/* Female focused fitness/yoga video */}
      ...
      <div className="relative z-30 flex h-full flex-col items-center justify-center px-4">
        ...
        >
            <h1 className="text-[12vw] leading-[0.8] font-display font-bold uppercase tracking-tighter text-white text-center drop-shadow-2xl">
        ...
        >
          <p className="max-w-xl text-sm md:text-xl font-medium tracking-widest text-sanctum-white/90 uppercase drop-shadow-md border-l-2 border-sanctum-orange pl-4 bg-black/40 backdrop-blur-sm">
            Nanded's Premier Women-Only Fitness Center
          </p>
          <div className="flex gap-4 items-center">
            <span className="text-xs text-sanctum-orange font-bold tracking-widest uppercase">Certified Trainers</span>
            <span className="h-1 w-1 rounded-full bg-white"></span>
            <span className="text-xs text-white font-bold tracking-widest uppercase">Women Only</span>
          </div>
        </motion.div>
      </div>
