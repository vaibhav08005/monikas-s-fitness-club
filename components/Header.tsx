...
const Header: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <div className="text-xl md:text-2xl font-display font-bold tracking-tighter uppercase cursor-pointer">
          MONIKA <span className="text-sanctum-orange">LADIES FITNESS</span>
        </div>
