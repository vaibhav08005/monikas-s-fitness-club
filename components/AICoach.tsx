...
const AICoach: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: 'Hello! I am Coach Monika. Welcome to our women-only fitness community. Ask me about our Yoga classes, weight gain programs, or Zumba!' }
  ]);
  ...
  return (
    <>
      ...
      <motion.button
        ...
        className={`fixed bottom-8 right-8 z-40 flex h-16 w-16 items-center justify-center rounded-full bg-sanctum-orange text-white shadow-[0_0_30px_rgba(244,63,94,0.5)] transition-opacity duration-300 ${isOpen ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}
      >
          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-white/10 bg-black/50 px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="font-display text-lg font-bold tracking-wider text-white">COACH MONIKA</h3>
              </div>
              <button 
            ...
            <div className="border-t border-white/10 bg-black/80 p-4">
              <div className="relative flex items-center">
                <input
                  ...
                  placeholder="Ask about Yoga, Diet, etc..."
